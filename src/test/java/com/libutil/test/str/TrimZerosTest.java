...
public class TrimZerosTest {
  ...
  private static void testTrimZeros() {
    String[][] testData = { { "01.0", "1.0" }, { "01.01", "1.01" }, { "01.010", "1.01" }, { "01.010", "1.01" }, { "010.0", "10.0" }, { "010.01", "10.01" }, { "010.010", "10.01" }, { "102", "102" }, { "0102.030", "102.03" }, { "-010.010", "-10.01" }, { "-00", "-0" }, { "-00.00", "-0.0" }, { "", "" }, { null, null } };
  ...
  private static void testTrimLeadingZeros() {
    String[][] testData = { { "01", "1" }, { "001", "1" }, { "0010", "10" }, { "010", "10" }, { "1", "1" }, { "0", "0" }, { "00", "0" }, { "10", "10" }, { "-010", "-10" }, { "0102", "102" }, { "102", "102" }, { "0102.030", "102.030" }, { "", "" }, { null, null } };
    for (int i = 0; i < testData.length; i++) {
      String[] data = testData[i];
      String data_in = data[0];
      String data_expected = data[1];
  ...
  private static void testTrimTrailingZeros() {
    String[][] testData = { { "01", "01" }, { "001", "001" }, { "0010", "001" }, { "010", "01" }, { "1", "1" }, { "0", "0" }, { "00", "0" }, { "10", "1" }, { "-010", "-01" }, { "1020", "102" }, { "102", "102" }, { "0102.030", "0102.03" }, { "", "" }, { null, null } };
    for (int i = 0; i < testData.length; i++) {
      String[] data = testData[i];
      String data_in = data[0];
      String data_expected = data[1];
