...
public class IsAsciiTest {
  ...
  public static void main(String args[]) {
    Log.i("--- ASCII ---");
    TestUtil.assertTrue(StrUtil.isAscii(" !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~"));
    ...
    Log.i("--- non ASCII ---");
    TestUtil.assertFalse(StrUtil.isNonAscii(" !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~"));
    ...
    TestUtil.assertTrue(StrUtil.isNonAscii("😀"));
    TestUtil.assertTrue(StrUtil.isNonAscii("aあ😀"));
  }
